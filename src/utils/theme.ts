 ...
 * 主题配置文件
 * @Author: ahwgs
 * @Date: 2020-04-04 23:34:19
 * @Last Modified by: ahwgs
 * @Last Modified time: 2020-05-12 23:39:12
 */

import { px2rem } from './px2rem';

const primaryColor = '#3bba63';
const warning = 'rgb(230,92,87)';
const theme = {
  primary: primaryColor, // 主题色
  warning: warning,
  blackColor: '#3c3c3b', // 字体主色
  grayColor: '#7d7e80',
  tipColor: 'rgb(161,161,161)',
  backgroundColor: '#f5f5f5',
  bottomBarBgColor: '#f7f7f7',
  basePadding: px2rem(10), // 基准侧边距
  fontSizeXss: px2rem(8),
  fontSizeXs: px2rem(10),
  fontSizeSm: px2rem(12),
  fontSizeMd: px2rem(14),
  fontSizeLg: px2rem(16),
  fontSizeXl: px2rem(18),
  fontSizeXll: px2rem(20),
  navHeight: px2rem(44),
};
export default theme;

const brandPrimary = primaryColor;
const brandPrimaryTap = primaryColor;
